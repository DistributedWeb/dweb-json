...
module.exports = function (archive, opts) {
  ...
  var db = toiletdb({ name: '/dweb.json', fs: archive })
  var fileDb = opts.file ? toiletdb(opts.file) : null

  var that = {
    read: function (cb) {
      archive.stat('/dweb.json', function (err, stat) {
    ...
    write: function (key, val, cb) {
      ...
      // TODO: use dwebfs indexing false option, need to talk to mafintosh about
      //   https://botbot.me/freenode/dweb/2017-05-12/?msg=85554242&page=3
  ...
  function getdefaults () {
    return {
      title: '',
      description: '',
      url: 'dweb://' + stringKey(archive.key)
    }
  }
